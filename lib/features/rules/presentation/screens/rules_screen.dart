...
• учет результатов''',
            ...
            RuleItem(
                ...
                description:
                    'Определите свою задачу – объем дневного выполнения и цель дела. Объем – продолжительность или другой показатель для разового (дневного) выполнения (например, количество отжиманий, тем для изучения). Ориентировочная норма – 30-60 минут в день. Цель - то главное, для чего вам нужно это дело.',
...
Определите время начала выполнения дела (например, час, в котором хотите приступить к делу) для каждого из 6 дней''',
            ...
            RuleItem(
                title: 'Воскресенья!',
                description:
                    'Дело должно выполняться 6 дней в неделю - с Пн по Сб. «По желанию» переносить дело на другой день нельзя! Только при полной невозможности сделать его. Воскресенье - резерв для того, чтобы можно было выполнить дело, не сделанное в плановый день, осмыслить ход работы',
                icon: 'assets/icons/1357.png'),
            RuleItem(
                title: 'Учёт результатов выполнения дела',
                description: '''Результаты можно вносить только в день выполнения дела! 
Отмечайте так, как ощущаете:
