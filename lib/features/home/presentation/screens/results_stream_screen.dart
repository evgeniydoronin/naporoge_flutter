                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: Text(
                        streamResults['title'],
                        style:
                            TextStyle(color: AppColor.accentBOW, fontSize: AppFont.large, fontWeight: FontWeight.w500),
                        ...
                        children: [
                          ...
                          RichText(
                            text: TextSpan(
                              ...
                              style: TextStyle(
                                  fontWeight: FontWeight.w600, color: AppColor.deep, fontSize: AppFont.regular),
                              children: <TextSpan>[
                                TextSpan(
